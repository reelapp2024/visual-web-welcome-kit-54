...
import { Wrench, Droplets, PipeIcon, Zap, Settings, ShieldCheck } from 'lucide-react';
...
const PlumbingServices = () => {
  ...
  const getServiceIcon = (index) => {
    const icons = [Wrench, Droplets, PipeIcon, Zap, Settings, ShieldCheck];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            ...
            {isFromLocationPage && currentLocationName 
              ? ` serving ${currentLocationName} with 24/7 emergency response and expert technicians.`
              : ' with 24/7 emergency response and expert technicians.'
            }
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl w-16 h-16 flex items-center justify-center mb-6 text-white shadow-lg group-hover:scale-110 transition-transform duration-300">
