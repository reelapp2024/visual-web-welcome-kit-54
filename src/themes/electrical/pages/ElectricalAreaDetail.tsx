        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose max-w-none">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Detailed information about our electrical services in {slug} will be displayed here.
            </p>
          </div>
        </div>
      </section>
...
export default ElectricalAreaDetail;
