      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <a href="/roofing" className="text-xl md:text-2xl font-bold bg-gradient-to-r from-slate-700 to-orange-600 bg-clip-text text-transparent">
              Elite Roofing Pro
            </a>
          </div>
          ...
          <nav className="hidden md:flex space-x-6 lg:space-x-8">
            <a href="/roofing" className="text-gray-700 hover:text-slate-600 transition-all duration-300 font-medium relative group">
              Home
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-slate-700 transition-all duration-300 group-hover:w-full"></span>
            </a>
            <a href="/roofing/about" className="text-gray-700 hover:text-slate-600 transition-all duration-300 font-medium relative group">
              About
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-slate-700 transition-all duration-300 group-hover:w-full"></span>
            </a>
              ...
              <DropdownMenuContent className="bg-white border border-gray-200 shadow-lg z-50 min-w-[250px] p-2 font-poppins">
                {services.map((service) => (
                  <DropdownMenuItem key={service.slug} className="p-0">
                    <a 
                      ...
                      className="w-full px-4 py-3 text-gray-700 hover:text-slate-600 hover:bg-slate-50 rounded-md transition-all duration-200 font-medium block"
                    >
                      {service.name}
                    </a>
                  </DropdownMenuItem>
                ...
                <DropdownMenuItem className="p-0 border-t border-gray-100 mt-2 pt-2">
                  <a 
                    ...
                    className="w-full px-4 py-3 text-slate-600 font-semibold hover:bg-slate-50 rounded-md transition-all duration-200 block"
                  >
                    View All Services
                  </a>
                </DropdownMenuItem>
            ...
            <a href="/roofing/contact" className="text-gray-700 hover:text-slate-600 transition-all duration-300 font-medium relative group">
              Contact
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-slate-700 transition-all duration-300 group-hover:w-full"></span>
            </a>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white shadow-lg">
            <div className="px-2 pt-2 pb-3 space-y-1 max-h-96 overflow-y-auto">
              <a href="/roofing" className="block px-3 py-2 text-gray-700 hover:text-slate-600 hover:bg-slate-50 rounded-md font-medium transition-all duration-200">Home</a>
              <a href="/roofing/about" className="block px-3 py-2 text-gray-700 hover:text-slate-600 hover:bg-slate-50 rounded-md font-medium transition-all duration-200">About</a>
              ...
              <div className="px-3 py-2">
                ...
                <div className="pl-4 space-y-2">
                  {services.map((service) => (
                    <a key={service.slug} href={`/roofing/services/${service.slug}`} className="block py-2 text-sm text-gray-600 hover:text-slate-600 transition-colors duration-200 font-medium">
                      {service.name}
                    </a>
                  ))}
                  <a href="/roofing/services" className="block py-2 text-sm text-slate-600 font-semibold border-t border-gray-100 pt-3 mt-2">View All Services</a>
                </div>
              </div>
              ...
              <div className="px-3 py-2">
                ...
                <div className="pl-4 space-y-2">
                  {areas.map((area) => (
                    <a key={area.slug} href={`/roofing/areas/${area.slug}`} className="block py-2 text-sm text-gray-600 hover:text-slate-600 transition-colors duration-200 font-medium">
                      {area.name}
                    </a>
                  ))}
                  <a href="/roofing/areas" className="block py-2 text-sm text-slate-600 font-semibold border-t border-gray-100 pt-3 mt-2">View All Areas</a>
                </div>
              </div>

              <a href="/roofing/contact" className="block px-3 py-2 text-gray-700 hover:text-slate-600 hover:bg-slate-50 rounded-md font-medium transition-all duration-200">Contact</a>
              <div className="px-3 py-2">
