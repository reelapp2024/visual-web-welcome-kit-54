...
import { Phone, Clock, CheckCircle, Star, Zap, Home } from 'lucide-react';
...
const RoofingHero = () => {
  return (
    <section className="relative min-h-[700px] flex items-center justify-center overflow-hidden font-poppins">
      ...
      {/* Floating elements */}
      <div className="absolute top-20 left-10 w-20 h-20 bg-orange-400/20 rounded-full blur-xl animate-bounce-slow"></div>
      <div className="absolute bottom-20 right-10 w-32 h-32 bg-slate-400/20 rounded-full blur-xl animate-bounce-slow delay-1000"></div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8 text-white/90 text-sm">
            <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
              <CheckCircle size={16} className="mr-2 text-orange-400" />
              <span className="font-medium">Licensed & Bonded</span>
            </div>
            <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
              <Home size={16} className="mr-2 text-slate-400" />
              <span className="font-medium">Emergency Service</span>
            </div>
            <div className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/20">
              <Star size={16} className="mr-2 text-orange-400" />
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-white mb-6 leading-tight">
            Professional
            <span className="block bg-gradient-to-r from-orange-400 via-slate-400 to-orange-500 bg-clip-text text-transparent animate-pulse">
              Roofing Services
            </span>
          ...
          <p className="text-lg sm:text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            🏠 Same-day service • 🛡️ Fully insured • ⚡ Licensed roofers in 30 minutes
          </p>
          ...
          <div className="mb-8">
            <div className="inline-flex items-center justify-center bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-md rounded-2xl p-4 sm:p-6 border border-white/30 shadow-2xl">
              <Phone size={28} className="text-orange-400 mr-3 sm:mr-4 animate-pulse flex-shrink-0" />
          ...
          {/* Urgency Message */}
          <div className="bg-gradient-to-r from-slate-500/80 to-orange-500/80 backdrop-blur-sm rounded-xl p-4 border border-white/20">
            <p className="text-white font-bold text-base sm:text-lg lg:text-xl flex items-center justify-center flex-wrap gap-2">
              <Zap className="text-orange-400 animate-pulse flex-shrink-0" />
              <span className="text-center">24/7 Emergency Roofing Service - Call Now!</span>
              <Zap className="text-orange-400 animate-pulse flex-shrink-0" />
            </p>
          </div>
        </div>
      ...
      <div className="fixed bottom-6 right-6 z-50 md:hidden">
        <a 
          href="tel:5551234567"
          className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-400 hover:to-orange-500 text-white p-4 rounded-full shadow-2xl animate-bounce-slow"
        >
          <Phone size={24} />
        </a>
      </div>
