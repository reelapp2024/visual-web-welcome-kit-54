  ...
  const services = [
    {
      ...
      link: "/cleaning/services/residential"
    },
    {
      icon: <Building className="w-8 h-8" />,
      title: "Commercial Cleaning", 
      description: "Office and business cleaning",
      link: "/cleaning/services/commercial"
    },
    {
      icon: <Sparkles className="w-8 h-8" />,
      title: "Deep Cleaning",
      description: "Thorough deep cleaning service",
      link: "/cleaning/services/deep-cleaning"
    },
    {
      icon: <Sofa className="w-8 h-8" />,
      title: "Upholstery Cleaning",
      description: "Furniture and fabric cleaning",
      link: "/cleaning/services/upholstery"
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            <a
              key={index}
              href={service.link}
              className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-4 border border-gray-100"
            >
