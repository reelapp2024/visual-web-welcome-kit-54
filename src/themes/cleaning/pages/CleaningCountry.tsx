      ...
      <section className="relative py-20 bg-gradient-to-br from-green-600 to-emerald-600 text-white overflow-hidden min-h-[500px] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full">
          <div className="flex items-center justify-center mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold">United States Cleaning Services</h1>
          </div>
          <p className="text-xl text-green-100 max-w-3xl mx-auto">
            Professional cleaning services across the United States with nationwide coverage 
