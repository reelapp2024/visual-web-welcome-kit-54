...
const RemodelingHero = () => {
  return (
    <section className="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 py-12 md:py-20 font-poppins">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="space-y-3 lg:space-y-4 mb-6 lg:mb-8">
              <div className="flex items-center justify-center lg:justify-start text-base lg:text-lg text-gray-700">
                <CheckCircle className="text-amber-600 mr-3 flex-shrink-0" size={20} />
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              <a 
                href="tel:5551234567"
                className="bg-gradient-to-r from-amber-600 to-orange-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base lg:text-lg font-semibold hover:from-amber-700 hover:to-orange-700 transition-all duration-300 transform hover:scale-105 flex items-center justify-center shadow-lg"
              >
                <Phone className="mr-2 lg:mr-3 flex-shrink-0" size={20} />
                <span className="whitespace-nowrap">Call Now: (555) 123-4567</span>
              </a>
              <button className="border-2 border-amber-600 text-amber-600 px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base lg:text-lg font-semibold hover:bg-amber-600 hover:text-white transition-all duration-300 transform hover:scale-105">
                Get Free Quote
              </button>
            </div>
          </div>
          ...
          <div className="relative mt-8 lg:mt-0">
            <div className="bg-gradient-to-br from-amber-100 to-orange-100 rounded-3xl p-6 lg:p-8 shadow-2xl">
              <img 
            ...
            <div className="absolute -bottom-4 lg:-bottom-6 -left-4 lg:-left-6 bg-white p-4 lg:p-6 rounded-2xl shadow-xl">
              <div className="text-2xl lg:text-3xl font-bold text-amber-600">500+</div>
            ...
            <div className="absolute -top-4 lg:-top-6 -right-4 lg:-right-6 bg-white p-4 lg:p-6 rounded-2xl shadow-xl">
              <div className="text-2xl lg:text-3xl font-bold text-orange-600">15+</div>
