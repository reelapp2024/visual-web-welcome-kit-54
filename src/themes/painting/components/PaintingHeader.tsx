...
const PaintingHeader = () => {
  ...
  const navigationItems = [
    { name: 'Home', href: '/painting' },
    { name: 'About', href: '/painting/about' },
    { name: 'Services', href: '/painting/services' },
    { name: 'Areas', href: '/painting/areas' },
    { name: 'Contact', href: '/painting/contact' }
  ];
